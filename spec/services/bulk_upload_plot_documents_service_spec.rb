...
RSpec.describe BulkUploadPlotDocumentsService do
  describe "#find_matches" do
    ...
    let(:plot1) { create(:plot, unit_type: unit_type, number: "1") }
    let(:plot120) { create(:plot, unit_type: unit_type, number: "1.20") }
    let(:plot176) { create(:plot, unit_type: unit_type, number: "1.7.6") }
    let(:plot1a) { create(:plot, unit_type: unit_type, number: "1a") }
