...
RSpec.describe DocumentLibraryService do
  context "sorts documents" do
    it "sorts and returns only the 6 most recent" do
      ...
      document6 = create(:document, title: "Developer document 20", file: "Document9.pdf", developer: developer)
      document7 = create(:document, title: "Developer document 4", file: "Document9.pdf", developer: developer)
      documents = []
