...
ActiveRecord::Schema.define(version: 20200321154858) do
  ...
  create_table "how_tos", force: :cascade do |t|
    ...
    t.index "lower(title) varchar_pattern_ops", name: "search_index_on_how_to_description", using: :btree
  ...
  create_table "residents", force: :cascade do |t|
    ...
    t.boolean  "developer_sms_updates"
