...
unless DefaultFaq.find_by(country_id: UK_id)
  ...
  <ul>
  	<li>The power and/or appliance is switched on</li>
  	<li>The plug is firmly attached in the socket</li>
  	<li>The fuse in the spur is intact</li>
  	<li>An MCB on the consumer unit has tripped</li>
  	<li>The door is firmly shut, where applicable</li>
  	<li>The inlet hose, where applicable, is squashed or bent</li>
  	<li>The inlet hose, where applicable, is blocked (you may need to clean the filter after you have switched off the water supply)</li>
  	<li>You have consulted your manual for the correct programme settings</li>
  </ul>
  ...
  <p>You should test your alarms on a weekly basis and change the batteries when needed. &nbsp;</p>
