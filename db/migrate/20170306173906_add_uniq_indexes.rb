class AddUniqIndexes < ActiveRecord::Migration[5.0]
  def change
    ...
    add_index :developments, [:name, :division_id], unique: true, where: "deleted_at IS NULL"
    add_index :developments, [:name, :developer_id], unique: true, where: "deleted_at IS NULL"
