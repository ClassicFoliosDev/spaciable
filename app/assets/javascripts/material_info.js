(function (document, $) {
  ...
  var checks = [{datum: '#development_material_info_attributes_tenure', 
                ...
                {datum: '#development_material_info_attributes_lease_length', 
                 label: 'div.development_material_info_lease_length label'},
                ...
                {datum: '#development_material_info_attributes_floor', 
                 label: 'div.development_material_info_floor label'},
