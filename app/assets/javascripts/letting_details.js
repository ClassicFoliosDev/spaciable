(function (document, $) {
  ...
  $(document).on('click', '.let-plot', function (event) {
    ...
    document.getElementById('letting_landlord_pets_policy').value =  'No Pets'
  ...
  $(document).on('input', '.let-plot-details-form', function (event) {
    validateLetting()
  })
