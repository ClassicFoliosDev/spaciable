...
Then(/^I should find the default FAQs$/) do
  ...
  expect(questions).to include "There is a white powder on my external walls. Is this a defect?"
  ...
  expect(answers).to include "For large and persistent stains you should call a professional carpet cleaner."
  ...
  expect(answers).to include "instead call a suitable qualified electrician to correct the fault."
