...
Feature: Logs
  ...
  Scenario:
    ...
    Then I should see a CreateFixture.bedroom_name updated log entry created by $current_user.full_name
    ...
    Then I should see a CreateFixture.bedroom_name deleted log entry created by $current_user.full_name
    ...
    And I should see a CreateFixture.bedroom_name updated log entry created by "CF Admin"
    ...
    And I should see a CreateFixture.finish_name removed log entry created by "CF Admin"
    And I should see a CreateFixture.bedroom_name deleted log entry created by "CF Admin"
    When I add a room to the unit type
    Then I should see a CreateFixture.room_name created log entry created by $current_user.full_name
    When I edit a room for the unit type
    Then I should see a CreateFixture.bedroom_name updated log entry created by $current_user.full_name
    ...
    And I should see a CreateFixture.bedroom_name updated log entry created by LettingsFixture.developer_admins.first.full_name
    ...
    And I should see a CreateFixture.finish_name removed log entry created by LettingsFixture.developer_admins.first.full_name
    And I should see a CreateFixture.bedroom_name deleted log entry created by LettingsFixture.developer_admins.first.full_name
