...
crumb :spotlights do |spotlight_parent|
  link t("breadcrumbs.spotlights"), ([spotlight_parent, :spotlights])
  parent :development, spotlight_parent
end

crumb :spotlight_add do |spotlight_parent|
  link t("breadcrumbs.spotlight_add"), [:new, spotlight_parent, :spotlight]
  parent :spotlights, spotlight_parent
end

crumb :spotlight do |spotlight|
  link spotlight.title
